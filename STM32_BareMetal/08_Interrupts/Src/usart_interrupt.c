...
// Initlialize USART RX using interrupts some data via USART2 using interrupts
// Initialization of USART TX functionality using interrupts still remaining - see page 227 Mazidi (**must do this)
